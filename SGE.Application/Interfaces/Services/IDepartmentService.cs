...
/// </summary>
public interface IDepartmentService : IExportData
{
    /// <summary>
    ...
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains an enumerable collection of
    ///     <see cref="DepartmentDto" />.
    /// </returns>
    ...
    /// <param name="cancellationToken">A cancellation token that can be used to cancel the operation.</param>
    /// <returns>
    ///     A task representing the asynchronous operation. The task result contains the <see cref="DepartmentDto" /> for
