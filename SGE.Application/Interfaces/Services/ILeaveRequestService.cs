...
/// </summary>
public interface ILeaveRequestService : IExportData
{
    ...
    Task<IEnumerable<LeaveRequestDto>> GetByEmployeeIdAsync(int employeeId, CancellationToken cancellationToken = default);
    ...
    Task<bool> ApproveAsync(int id, string approvedBy, string? comments = null, CancellationToken cancellationToken = default);
    Task<bool> RejectAsync(int id, string rejectedBy, string? comments = null, CancellationToken cancellationToken = default);
    Task<bool> DeleteAsync(int id, CancellationToken cancellationToken = default);
    Task<List<LeaveRequestDto>> ImportFile(FileUploadModel fileUploadModel);
}