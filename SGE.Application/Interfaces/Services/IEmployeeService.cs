...
/// </summary>
public interface IEmployeeService : IExportData
{
    /// <summary>
    ...
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains an enumerable collection of employee
    ///     data transfer objects (EmployeeDto).
    /// </returns>
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the employee data transfer object
    ///     (EmployeeDto) if found, otherwise null.
    /// </returns>
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result contains the created employee data transfer
    ///     object (EmployeeDto).
    /// </returns>
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>
    ///     A task that represents the asynchronous operation. The task result is a boolean value indicating whether the update
    ///     was successful.
    /// </returns>
